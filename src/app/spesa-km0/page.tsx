...
export const metadata = {
  ...
  description:
    "Scegli la tua città e scopri spacci aziendali, produttori biologici e prodotti locali con impronta del trasporto misurata. Compra vicino a te, riduci la CO₂ di trasporto.",
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <p className="mt-3 max-w-2xl text-green-900/80">
        ...
        vicino a te. Ogni prodotto ha un&apos;impronta del trasporto misurata: così
